...
import screens.TableLayout

const val API_KEY = "58429fae52734ed689c200308232203"
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            getData("Ukraine", this, daysList, currentDay)
            Image(
            ...
            Column {
                MainCard(currentDay, onClickSync = {
                    getData("Ukraine", this@MainActivity, daysList, currentDay)
                },  onClickSearch = {
